...
double AvgMethodTwo = Myarr.Average();
Console.WriteLine("Questa è la media calcolata a Mano {0}", Avg);
Console.WriteLine("Questa è la media calcolata con il metodo Average {0}", AvgMethodTwo);